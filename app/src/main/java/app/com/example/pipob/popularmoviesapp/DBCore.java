...
public class DBCore extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE Movie(_id integer primary key autoincrement, name text not null, date text not null, imageUrl text not null, rating real not null, overview text not null);");
    }
