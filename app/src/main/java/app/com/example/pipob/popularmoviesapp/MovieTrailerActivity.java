...
/**
 * Created by FirstPlace on 28/07/2016.
 */
public class MovieTrailerActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener{
    public  String API_KEY ;
    public final String VIDEO_ID = "b1cyu33SNL8";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_selected_movie_trailer);
/** Initializing YouTube Player View **/
        API_KEY= this.getString(R.string.apiYoutubeKey);
